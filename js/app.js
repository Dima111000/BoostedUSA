(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".brand-swiper-page__slider", {
                loop: true,
                slidesPerView: 1,
                modules: [ Autoplay ],
                spaceBetween: 0,
            ...
            new core(".electric-scooter-page__slider", {
                loop: true,
                slidesPerView: 1,
                spaceBetween: 15,
            ...
            new core(".product-swiper-page__slider", {
                loop: true,
                slidesPerView: 1,
                modules: [ Navigation ],
                allowTouchMove: false,
    ...
    document.getElementById("getFullYear").innerHTML = currentYear;
    var scooterItem = document.querySelector(".electric-scooter-page__item");
    var scooterElemCount = document.getElementsByClassName("electric-scooter-page__image-block")[0].childElementCount;
    if (scooterElemCount > 2) scooterItem.classList.add("flex-dir-col"); else scooterItem.classList.remove("flex-dir-col");
    const headerSticky = document.querySelector(".header");
    const content = document.querySelector(".page").firstElementChild;
    const headerTop = headerSticky.offsetTop;
